...
# =========================
# The "Time" feature is not very informative here, so we remove it
...
results.append(evaluate_model("Class Weight", model_weight, X_val, y_val, X_test, y_test))
...
results.append(evaluate_model("SMOTE", model_smote, X_val, y_val, X_test, y_test))
